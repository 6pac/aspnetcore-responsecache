...
internal sealed class AspNetCorePlus_SegmentWriteStream : Stream
{
    ...
    internal AspNetCorePlus_SegmentWriteStream(int segmentSize)
    {
        if (segmentSize <= 0)
        {
    ...
    public override void Flush()
    {
        if (!CanWrite)
        {
            throw new ObjectDisposedException(nameof(AspNetCorePlus_SegmentWriteStream), "The stream has been closed for writing.");
        }
    }
