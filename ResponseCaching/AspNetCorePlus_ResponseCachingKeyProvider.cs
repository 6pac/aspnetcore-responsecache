...
internal sealed class AspNetCorePlus_ResponseCachingKeyProvider : IAspNetCorePlus_ResponseCachingKeyProvider
{
    ...
    internal AspNetCorePlus_ResponseCachingKeyProvider(ObjectPoolProvider poolProvider, IOptions<AspNetCorePlus_ResponseCachingOptions> options)
    {
    ...
    public IEnumerable<string> CreateLookupVaryByKeys(AspNetCorePlus_ResponseCachingContext context)
    {
        return new string[] { CreateStorageVaryByKey(context) };
    }

    // GET<delimiter>SCHEME<delimiter>HOST:PORT/PATHBASE/PATH
    public string CreateBaseKey(AspNetCorePlus_ResponseCachingContext context)
    {
    ...
    public string CreateStorageVaryByKey(AspNetCorePlus_ResponseCachingContext context)
    {
        ArgumentNullException.ThrowIfNull(context);
        ...
        if (varyByRules == null)
        {
            throw new InvalidOperationException($"{nameof(AspNetCorePlus_CachedVaryByRules)} must not be null on the {nameof(AspNetCorePlus_ResponseCachingContext)}");
        }
