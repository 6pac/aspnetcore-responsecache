...
/// <summary>
/// Options for configuring the <see cref="AspNetCorePlus_ResponseCachingMiddleware"/>.
/// </summary>
public class AspNetCorePlus_ResponseCachingOptions
{
    /// <summary>
    ...
    /// If the response body exceeds this limit, it will not be cached by the <see cref="AspNetCorePlus_ResponseCachingMiddleware"/>.
    /// </summary>
