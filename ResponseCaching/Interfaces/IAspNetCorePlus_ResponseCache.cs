...
internal interface IAspNetCorePlus_ResponseCache
{
    /// <summary>
    ...
    IAspNetCorePlus_ResponseCacheEntry? Get(string key);
    ...
    void Set(string key, IAspNetCorePlus_ResponseCacheEntry entry, TimeSpan validFor);
}
