...
internal sealed class AspNetCorePlus_FastGuid
{
    ...
    internal AspNetCorePlus_FastGuid(long id)
    {
        IdValue = id;
    }

    internal static AspNetCorePlus_FastGuid NewGuid()
    {
        return new AspNetCorePlus_FastGuid(Interlocked.Increment(ref NextId));
    }

    private static string GenerateGuidString(AspNetCorePlus_FastGuid guid)
    {
