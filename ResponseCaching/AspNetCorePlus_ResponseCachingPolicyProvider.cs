...
internal sealed class AspNetCorePlus_ResponseCachingPolicyProvider : IAspNetCorePlus_ResponseCachingPolicyProvider
{
  public bool AttemptResponseCaching(AspNetCorePlus_ResponseCachingContext context, AspNetCorePlus_ResponseCachingOptions _options)
  {
  ...
  public bool AllowCacheLookup(AspNetCorePlus_ResponseCachingContext context)
  {
    ...
    public bool AllowCacheStorage(AspNetCorePlus_ResponseCachingContext context)
    {
    ...
    public bool IsResponseCacheable(AspNetCorePlus_ResponseCachingContext context)
    {
    ...
    public bool IsCachedEntryFresh(AspNetCorePlus_ResponseCachingContext context)
    {
